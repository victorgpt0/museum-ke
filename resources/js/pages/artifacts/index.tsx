...
>>>>>>> d3b135e6096e26af453ef2e857b0548d18f3b32e
                    <img
                        src={thumbnail_url || 'https://placehold.co/200x200?text=IMG'}
                        alt={'Artifact thumbnail'}
...
=======
        ...
        },
        {
            label: 'Condition',
            accessor: 'condition',
            render: (condition: string) => <Badge variant={condition === 'good' ? 'default' : 'destructive'}>{condition}</Badge>,
        },
        {
            label: 'Status',
            accessor: 'status',
            render: (status: string) => <Badge variant="outline">{status}</Badge>,
        },
    ];
...
>>>>>>> d3b135e6096e26af453ef2e857b0548d18f3b32e
                ...
                <Card className="mb-6">
                    <CardContent className="p-4">
                        <div className="mb-4 flex gap-2">
                            <Button variant={tab === 'all' ? 'default' : 'outline'} onClick={() => handleTabChange('all')}>
                                All Artifacts
                            </Button>
                            <Button variant={tab === 'mine' ? 'default' : 'outline'} onClick={() => handleTabChange('mine')}>
                                My Artifacts
                            </Button>
                            <Button variant={tab === 'others' ? 'default' : 'outline'} onClick={() => handleTabChange('others')}>
                                Others' Artifacts
                            </Button>
                            <div className="ml-auto flex gap-2">
                        ...
                        <form onSubmit={submitFilter} className="flex flex-wrap gap-2">
                            <div className="flex flex-wrap gap-2">
                                <Input
                                    ...
                                    className="w-48"
                                />
                                <Select value={filter.category_id || ''} onValueChange={(value) => handleSelectChange('category_id', value)}>
                                    <SelectTrigger className="w-40">
                                        <SelectValue placeholder="All Categories" />
                                    </SelectTrigger>
                                    <SelectContent>
                                ...
                                <Select value={filter.condition || ''} onValueChange={(value) => handleSelectChange('condition', value)}>
                                    <SelectTrigger className="w-40">
                                        <SelectValue placeholder="All Conditions" />
                                    </SelectTrigger>
                                    <SelectContent>
                ...
                {view === 'table' ? (
                    ...
                    <>
                                ...
                                <Card key={artifact.id} className="overflow-hidden">
                                    ...
                                    <CardContent className="p-4">
                                        <div className="mb-2 text-lg font-bold">
                                            <Link href={route('artifacts.show', artifact.id)} className="text-gray-900 hover:underline">
                                                {artifact.title}
                                            </Link>
                                        </div>
                                        <div className="mb-2 text-sm text-gray-600">Category: {artifact.category?.title}</div>
                                        <div className="mb-2 flex gap-2">
                                            <Badge variant={artifact.condition === 'good' ? 'default' : 'destructive'}>{artifact.condition}</Badge>
                                            <Badge variant="outline">{artifact.status}</Badge>
                                        </div>
                                        <div className="mb-3 text-sm text-gray-500">Location: {artifact.location || 'Not specified'}</div>
                        ...
                        <Pagination links={artifacts.links} from={artifacts.from} to={artifacts.to} total={artifacts.total} />
                    </>
                )}
            </div>
        </AppLayout>
