  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    for (let [key, value] of formData.entries()) {
      console.log(`${key}:`, value);
        ...
        router.post(
      route('findings.store', { project: project.id }),
      formData,
      {
        forceFormData: true,
        preserveState: false,
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-1 flex flex-col items-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-md">
                  ...
                  {documentPreviews.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-3">
                      {documentPreviews.map((fileName, index) => (
                        <div key={index} className="flex items-center bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full shadow text-sm">
                  ...
                  {errors.documents && <p className="text-sm text-red-500 mt-2">{errors.documents}</p>}
                </div>
